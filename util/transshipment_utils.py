...
def plot_transshipment_network(nodes, supply, demand, cost, flow):
    ...
    # Automatically position nodes using spring layout
    pos = nx.spring_layout(G)

    """
    If you want to customise the positioning of nodes for better distribution in the plot,
    uncomment the following dictionary and set the positions as desired:
